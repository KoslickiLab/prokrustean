...
void help(){
	...
	"Input: Prokrustean Graph. Input2: Sequence Access." << endl <<
	"Output: compacted de bruijn graph in a text file." << endl <<
	"Options:" << endl <<
	"-h          help" << endl <<
...
int main(int argc, char** argv){
    ...
    extract_paritial_unitigs(k, ext, seq_texts, workspace);
